...
public class SwaggerConfig {
	...
	private ApiInfo apiInfo() {
		return new ApiInfo("Livraria virtual REST API", "O seu objetivo é implementar uma API para a gestão de uma livraria virtual. Uma livraria virtual deve ter pelo menos funcionalidades para:\r\n" + 
